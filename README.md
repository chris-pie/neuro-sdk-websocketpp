...
[zaphoyd/websocketpp](https://github.com/zaphoyd/websocketpp) - included as a submodule. This one requires Boost to be installed. See `no-boost` branch for a version not requiring Boost.
